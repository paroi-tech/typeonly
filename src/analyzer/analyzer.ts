import { AstArrayType, AstCompositeType, AstDeclaration, AstFunctionParameter, AstFunctionProperty, AstFunctionType, AstGenericType, AstImport, AstIndexSignature, AstInlineComment, AstInlineImportType, AstInterface, AstInterfaceEntry, AstLiteralType, AstMappedIndexSignature, AstNamedInterface, AstNamedType, AstProperty, AstTupleType, AstType, TypeOnlyAst } from "../ast"
import { ArrayType, FunctionParameter, FunctionType, GenericType, GlobalTypeRef, IndexSignature, Interface, LiteralType, MappedIndexSignature, NamedType, NamedTypeFields, PrimitiveTypeRef, Properties, Property, SpecialTypeRef, TupleType, Type, TypeOnlyContainer, TypeOnlyEmbeddedCode, TypeRef, UnionType } from "../typeonly-types"
...
function analyzeAstNamedInterface(astNode: AstNamedInterface, container: TypeOnlyContainer): NamedType {
...
function analyzeAstGenericType(astNode: AstGenericType): GenericType {
  return {
    whichType: "generic",
...
function analyzeAstNamedType(astNode: AstNamedType, container: TypeOnlyContainer): NamedType {
